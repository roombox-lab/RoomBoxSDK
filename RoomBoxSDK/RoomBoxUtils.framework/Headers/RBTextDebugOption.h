 ...
 */
@protocol RBTextDebugTarget <NSObject>
 ...
 */
- (void)setDebugOption:(nullable RBTextDebugOption *)option;
@end
 ...
 */
@interface RBTextDebugOption : NSObject <NSCopying>
 ...
 */
+ (void)addDebugTarget:(id<RBTextDebugTarget>)target;
...
/**
 ...
 @param target A debug target.
 */
+ (void)removeDebugTarget:(id<RBTextDebugTarget>)target;
 ...
 */
+ (nullable RBTextDebugOption *)sharedDebugOption;
 ...
 */
+ (void)setSharedDebugOption:(nullable RBTextDebugOption *)option;
