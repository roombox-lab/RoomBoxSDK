 ...
 */
FOUNDATION_EXPORT const int64_t RBWebImageProgressUnitCountUnknown; /* 1LL */

typedef void(^RBSetImageBlock)(UIImage * _Nullable image, NSData * _Nullable imageData, RBImageCacheType cacheType, NSURL * _Nullable imageURL);

/**
 Integrates SDWebImage async downloading and caching of remote images with UIView subclass.
 */
@interface UIView (RBWebCache)
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSURL *rb_imageURL;
 ...
 * See more about this in `RBWebImageContextSetImageOperationKey`.
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSString *rb_latestOperationKey;
 ...
 */
@property (nonatomic, strong, null_resettable) NSProgress *rb_imageProgress;
 ...
 */
- (void)rb_internalSetImageWithURL:(nullable NSURL *)url
                  placeholderImage:(nullable UIImage *)placeholder
                           options:(RBWebImageOptions)options
                           context:(nullable RBWebImageContext *)context
                     setImageBlock:(nullable RBSetImageBlock)setImageBlock
                          progress:(nullable RBImageLoaderProgressBlock)progressBlock
                         completed:(nullable RBInternalCompletionBlock)completedBlock;
 ...
 */
@property (nonatomic, strong, nullable) RBWebImageTransition *rb_imageTransition;
 ...
 */
@property (nonatomic, strong, nullable) id<RBWebImageIndicator> rb_imageIndicator;
