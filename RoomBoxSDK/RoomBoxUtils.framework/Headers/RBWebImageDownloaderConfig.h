...
typedef NS_ENUM(NSInteger, RBWebImageDownloaderExecutionOrder) {
    /**
 ...
 */
@interface RBWebImageDownloaderConfig : NSObject <NSCopying>
 ...
 */
@property (nonatomic, class, readonly, nonnull) RBWebImageDownloaderConfig *defaultDownloaderConfig;
 ...
 */
@property (nonatomic, assign) RBWebImageDownloaderExecutionOrder executionOrder;
