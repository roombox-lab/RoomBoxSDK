...
@interface RBImageHEICCoder : RBImageIOAnimatedCoder <RBProgressiveImageCoder, RBAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) RBImageHEICCoder *sharedCoder;
