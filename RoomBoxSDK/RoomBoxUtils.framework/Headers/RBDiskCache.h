 ...
 */
- (nullable instancetype)initWithCachePath:(nonnull NSString *)cachePath config:(nonnull RBImageCacheConfig *)config;
 ...
 */
@interface RBDiskCache : NSObject <RBDiskCache>
/**
 Cache Config object - storing all kind of settings.
 */
@property (nonatomic, strong, readonly, nonnull) RBImageCacheConfig *config;
