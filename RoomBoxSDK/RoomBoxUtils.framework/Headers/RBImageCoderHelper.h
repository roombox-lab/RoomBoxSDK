 ...
 */
@interface RBImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<RBImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<RBImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage NS_SWIFT_NAME(frames(from:));
