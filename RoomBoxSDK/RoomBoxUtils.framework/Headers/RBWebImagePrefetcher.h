...
@class RBWebImagePrefetcher;

/**
 A token represents a list of URLs, can be used to cancel the download.
 */
@interface RBWebImagePrefetchToken : NSObject <RBWebImageOperation>
 ...
 */
@protocol RBWebImagePrefetcherDelegate <NSObject>
 ...
 */
- (void)imagePrefetcher:(nonnull RBWebImagePrefetcher *)imagePrefetcher didPrefetchURL:(nullable NSURL *)imageURL finishedCount:(NSUInteger)finishedCount totalCount:(NSUInteger)totalCount;
 ...
 */
- (void)imagePrefetcher:(nonnull RBWebImagePrefetcher *)imagePrefetcher didFinishWithTotalCount:(NSUInteger)totalCount skippedCount:(NSUInteger)skippedCount;

@end

typedef void(^RBWebImagePrefetcherProgressBlock)(NSUInteger noOfFinishedUrls, NSUInteger noOfTotalUrls);
typedef void(^RBWebImagePrefetcherCompletionBlock)(NSUInteger noOfFinishedUrls, NSUInteger noOfSkippedUrls);

/**
 * Prefetch some URLs in the cache for future use. Images are downloaded in low priority.
 */
@interface RBWebImagePrefetcher : NSObject
 ...
 */
@property (strong, nonatomic, readonly, nonnull) RBWebImageManager *manager;
 ...
 */
@property (nonatomic, assign) RBWebImageOptions options;

/**
 * The context for prefetcher. Defaults to nil.
 */
@property (nonatomic, copy, nullable) RBWebImageContext *context;
 ...
 */
@property (weak, nonatomic, nullable) id <RBWebImagePrefetcherDelegate> delegate;

/**
 * Returns the global shared image prefetcher instance. It use a standalone manager which is different from shared manager.
 */
@property (nonatomic, class, readonly, nonnull) RBWebImagePrefetcher *sharedImagePrefetcher;

/**
 * Allows you to instantiate a prefetcher with any arbitrary image manager.
 */
- (nonnull instancetype)initWithImageManager:(nonnull RBWebImageManager *)manager NS_DESIGNATED_INITIALIZER;
 ...
 */
- (nullable RBWebImagePrefetchToken *)prefetchURLs:(nullable NSArray<NSURL *> *)urls;
 ...
 */
- (nullable RBWebImagePrefetchToken *)prefetchURLs:(nullable NSArray<NSURL *> *)urls
                                          progress:(nullable RBWebImagePrefetcherProgressBlock)progressBlock
                                         completed:(nullable RBWebImagePrefetcherCompletionBlock)completionBlock;
