...
@class RBTextAsyncLayerDisplayTask;
 ...
 */
@interface RBTextAsyncLayer : CALayer
 ...
 */
@protocol RBTextAsyncLayerDelegate <NSObject>
@required
/// This method is called to return a new display task when the layer's contents need update.
- (RBTextAsyncLayerDisplayTask *)newAsyncDisplayTask;
@end
 ...
 */
@interface RBTextAsyncLayerDisplayTask : NSObject
