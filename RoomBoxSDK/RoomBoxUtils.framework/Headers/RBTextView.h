...
/**
 The RBTextViewDelegate protocol defines a set of optional methods you can use
 to receive editing-related messages for RBTextView objects. 
 ...
 */
@protocol RBTextViewDelegate <NSObject, UIScrollViewDelegate>
@optional
- (BOOL)textViewShouldBeginEditing:(RBTextView *)textView;
- (BOOL)textViewShouldEndEditing:(RBTextView *)textView;
- (void)textViewDidBeginEditing:(RBTextView *)textView;
- (void)textViewDidEndEditing:(RBTextView *)textView;
- (BOOL)textView:(RBTextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text;
- (void)textViewDidChange:(RBTextView *)textView;
- (void)textViewDidChangeSelection:(RBTextView *)textView;

- (BOOL)textView:(RBTextView *)textView shouldTapHighlight:(RBTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(RBTextView *)textView didTapHighlight:(RBTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
- (BOOL)textView:(RBTextView *)textView shouldLongPressHighlight:(RBTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(RBTextView *)textView didLongPressHighlight:(RBTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
@end
...
/**
 The RBTextView class implements the behavior for a scrollable, multiline text region.
 ...
 * It allows to set an attributed text as placeholder.
 ...
 See NSAttributedString+RBText.h for more convenience methods to set the attributes.
 See RBTextAttribute.h and YYTextLayout.h for more information.
 */
@interface RBTextView : UIScrollView <UITextInput>
...
@property (nullable, nonatomic, weak) id<RBTextViewDelegate> delegate;
 ...
 */
@property (nonatomic) RBTextVerticalAlignment textVerticalAlignment;
...
/**
 ...
 @discussion It only support the attributes declared in CoreText and RBTextAttribute.
 See `NSAttributedString+RBText` for more convenience methods to set the attributes.
 */
 ...
 */
@property (nullable, nonatomic, strong) id<RBTextParser> textParser;

/**
 The current text layout in text view (readonly).
 It can be used to query the text layout information.
 */
@property (nullable, nonatomic, strong, readonly) RBTextLayout *textLayout;
 ...
 */
@property (nullable, nonatomic, copy) id<RBTextLinePositionModifier> linePositionModifier;

/**
 The debug option to display CoreText layout result.
 The default value is [YYTextDebugOption sharedDebugOption].
 */
@property (nullable, nonatomic, copy) RBTextDebugOption *debugOption;
...
@property (nonatomic) IBInspectable RBTextVerticalAlignment textVerticalAlignment;
...
UIKIT_EXTERN NSString *const RBTextViewTextDidBeginEditingNotification;
UIKIT_EXTERN NSString *const RBTextViewTextDidChangeNotification;
UIKIT_EXTERN NSString *const RBTextViewTextDidEndEditingNotification;
