 ...
 */
- (nonnull instancetype)initWithConfig:(nonnull RBImageCacheConfig *)config;
 ...
 */
@interface RBMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <RBMemoryCache>

@property (nonatomic, strong, nonnull, readonly) RBImageCacheConfig *config;
