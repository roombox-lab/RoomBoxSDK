...
typedef NSURLRequest * _Nullable (^RBWebImageDownloaderRequestModifierBlock)(NSURLRequest * _Nonnull request);
 ...
 */
@protocol RBWebImageDownloaderRequestModifier <NSObject>
 ...
 */
@interface RBWebImageDownloaderRequestModifier : NSObject <RBWebImageDownloaderRequestModifier>

/// Create the request modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull RBWebImageDownloaderRequestModifierBlock)block;

/// Create the request modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)requestModifierWithBlock:(nonnull RBWebImageDownloaderRequestModifierBlock)block;
...
*/
@interface RBWebImageDownloaderRequestModifier (Conveniences)
