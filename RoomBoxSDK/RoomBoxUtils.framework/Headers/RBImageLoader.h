...
typedef void(^RBImageLoaderProgressBlock)(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL);
typedef void(^RBImageLoaderCompletedBlock)(UIImage * _Nullable image, NSData * _Nullable data, NSError * _Nullable error, BOOL finished);
 ...
 */
FOUNDATION_EXPORT RBWebImageContextOption _Nonnull const RBWebImageContextLoaderCachedImage;
 ...
 */
FOUNDATION_EXPORT UIImage * _Nullable RBImageLoaderDecodeImageData(NSData * _Nonnull imageData, NSURL * _Nonnull imageURL, RBWebImageOptions options, RBWebImageContext * _Nullable context);
 ...
 */
FOUNDATION_EXPORT UIImage * _Nullable RBImageLoaderDecodeProgressiveImageData(NSData * _Nonnull imageData, NSURL * _Nonnull imageURL, BOOL finished,  id<RBWebImageOperation> _Nonnull operation, RBWebImageOptions options, RBWebImageContext * _Nullable context);
...
*/
@protocol RBImageLoader <NSObject>
 ...
 */
- (nullable id<RBWebImageOperation>)requestImageWithURL:(nullable NSURL *)url
                                                options:(RBWebImageOptions)options
                                                context:(nullable RBWebImageContext *)context
                                               progress:(nullable RBImageLoaderProgressBlock)progressBlock
                                              completed:(nullable RBImageLoaderCompletedBlock)completedBlock;
