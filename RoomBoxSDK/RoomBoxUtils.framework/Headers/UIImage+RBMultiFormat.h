 ...
 */
@interface UIImage (RBMultiFormat)
#pragma mark - Decode
/**
 ...
 */
+ (nullable UIImage *)rb_imageWithData:(nullable NSData *)data;
...
/**
 ...
 @return The created image
 */
+ (nullable UIImage *)rb_imageWithData:(nullable NSData *)data scale:(CGFloat)scale;
...
/**
 ...
 @return The created image
 */
+ (nullable UIImage *)rb_imageWithData:(nullable NSData *)data scale:(CGFloat)scale firstFrameOnly:(BOOL)firstFrameOnly;
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)rb_imageDataAsFormat:(RBImageFormat)imageFormat NS_SWIFT_NAME(sd_imageData(as:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)rb_imageDataAsFormat:(RBImageFormat)imageFormat compressionQuality:(double)compressionQuality NS_SWIFT_NAME(sd_imageData(as:compressionQuality:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)rb_imageDataAsFormat:(RBImageFormat)imageFormat compressionQuality:(double)compressionQuality firstFrameOnly:(BOOL)firstFrameOnly NS_SWIFT_NAME(sd_imageData(as:compressionQuality:firstFrameOnly:));
