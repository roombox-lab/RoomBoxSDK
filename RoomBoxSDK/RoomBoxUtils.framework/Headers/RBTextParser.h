...
/**
 The YYTextParser protocol declares the required method for RBTextView and YYLabel
 to modify the text during editing.
 
 You can implement this protocol to add code highlighting or emoticon replacement for
 RBTextView and YYLabel. See `YYTextSimpleMarkdownParser` and `YYTextSimpleEmoticonParser` for example.
 */
@protocol RBTextParser <NSObject>
@required
/**
 When text is changed in RBTextView or YYLabel, this method will be called.
 ...
 */
@interface RBTextSimpleMarkdownParser : NSObject <RBTextParser>
 ...
 */
@interface RBTextSimpleEmoticonParser : NSObject <RBTextParser>
