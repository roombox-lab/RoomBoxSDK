...
typedef NS_ENUM(NSUInteger, RBImageScaleMode) {
    RBImageScaleModeFill = 0,
    RBImageScaleModeAspectFit = 1,
    RBImageScaleModeAspectFill = 2
};

#if RB_UIKIT || RB_WATCH
typedef UIRectCorner RBRectCorner;
#else
typedef NS_OPTIONS(NSUInteger, RBRectCorner) {
    RBRectCornerTopLeft     = 1 << 0,
    RBRectCornerTopRight    = 1 << 1,
    RBRectCornerBottomLeft  = 1 << 2,
    RBRectCornerBottomRight = 1 << 3,
    RBRectCornerAllCorners  = ~0UL
};
#endif
 ...
 */
- (nullable UIImage *)rb_resizedImageWithSize:(CGSize)size scaleMode:(RBImageScaleMode)scaleMode;
 ...
 */
- (nullable UIImage *)rb_croppedImageWithRect:(CGRect)rect;
 ...
 */
- (nullable UIImage *)rb_roundedCornerImageWithRadius:(CGFloat)cornerRadius
                                              corners:(RBRectCorner)corners
 ...
 */
- (nullable UIImage *)rb_rotatedImageWithAngle:(CGFloat)angle fitSize:(BOOL)fitSize;
 ...
 */
- (nullable UIImage *)rb_flippedImageWithHorizontal:(BOOL)horizontal vertical:(BOOL)vertical;
 ...
 */
- (nullable UIImage *)rb_tintedImageWithColor:(nonnull UIColor *)tintColor;
 ...
 */
- (nullable UIColor *)rb_colorAtPoint:(CGPoint)point;
 ...
 */
- (nullable NSArray<UIColor *> *)rb_colorsWithRect:(CGRect)rect;
 ...
 */
- (nullable UIImage *)rb_blurredImageWithRadius:(CGFloat)blurRadius;
...
/**
 ...
 enough memory).
 */
- (nullable UIImage *)rb_filteredImageWithFilter:(nonnull CIFilter *)filter;
#endif
