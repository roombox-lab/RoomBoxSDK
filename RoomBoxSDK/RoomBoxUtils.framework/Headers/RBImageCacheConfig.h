 ...
 */
@interface RBImageCacheConfig : NSObject <NSCopying>
 ...
 */
@property (nonatomic, class, readonly, nonnull) RBImageCacheConfig *defaultCacheConfig;
 ...
 */
@property (assign, nonatomic) RBImageCacheConfigExpireType diskCacheExpireType;
