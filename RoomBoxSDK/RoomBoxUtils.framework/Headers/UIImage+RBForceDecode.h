 ...
 */
+ (nullable UIImage *)rb_decodedImageWithImage:(nullable UIImage *)image;
 ...
 */
+ (nullable UIImage *)rb_decodedAndScaledDownImageWithImage:(nullable UIImage *)image;
...
/**
 ...
 @return The decoded and scaled down image
 */
+ (nullable UIImage *)rb_decodedAndScaledDownImageWithImage:(nullable UIImage *)image limitBytes:(NSUInteger)bytes;
