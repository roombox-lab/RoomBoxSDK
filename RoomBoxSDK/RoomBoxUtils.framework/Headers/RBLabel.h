 ...
 */
@interface RBLabel : UIView <NSCoding>
 ...
 */
@property (nullable, nonatomic, strong) RBTextLayout *textLayout;
...
/**
 ...
 The default value is nil.
 */
@property (nullable, nonatomic, copy) RBTextAction textTapAction;

/**
 When user long press the label, this action will be called (similar to long press gesture).
 The default value is nil.
 */
@property (nullable, nonatomic, copy) RBTextAction textLongPressAction;

/**
 When user tap the highlight range of text, this action will be called.
 The default value is nil.
 */
@property (nullable, nonatomic, copy) RBTextAction highlightTapAction;

/**
 When user long press the highlight range of text, this action will be called.
 The default value is nil. 
 */
@property (nullable, nonatomic, copy) RBTextAction highlightLongPressAction;
...
@property (nonatomic) UIEdgeInsets textContainerInset;
@property (nullable, nonatomic, copy) id<RBTextLinePositionModifier> linePositionModifier;
@property (nonnull, nonatomic, copy) RBTextDebugOption *debugOption;
@property (nullable, nonatomic, copy) RBTextAction textTapAction;
@property (nullable, nonatomic, copy) RBTextAction textLongPressAction;
@property (nullable, nonatomic, copy) RBTextAction highlightTapAction;
@property (nullable, nonatomic, copy) RBTextAction highlightLongPressAction;
