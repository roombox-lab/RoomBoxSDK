 ...
 */
@interface RBImageGIFCoder : RBImageIOAnimatedCoder <RBProgressiveImageCoder, RBAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) RBImageGIFCoder *sharedCoder;
