 ...
 */
@property (nonatomic, assign) NSUInteger rb_imageLoopCount;
 ...
 */
@property (nonatomic, assign, readonly) BOOL rb_isAnimated;
 ...
 */
@property (nonatomic, assign, readonly) BOOL rb_isVector;
