...
typedef NSString * RBImageCoderOption NS_STRING_ENUM;
typedef NSDictionary<RBImageCoderOption, id> RBImageCoderOptions;
typedef NSMutableDictionary<RBImageCoderOption, id> RBImageCoderMutableOptions;
 ...
 */
FOUNDATION_EXPORT RBImageCoderOption _Nonnull const RBImageCoderDecodeFirstFrameOnly;
 ...
 */
FOUNDATION_EXPORT RBImageCoderOption _Nonnull const RBImageCoderDecodeScaleFactor;
...
/**
 ...
 @note works for `SDImageCoder`, `SDProgressiveImageCoder`, `SDAnimatedImageCoder`.
 */
FOUNDATION_EXPORT RBImageCoderOption _Nonnull const RBImageCoderDecodePreserveAspectRatio;
...
/**
 ...
 @note works for `SDImageCoder`, `SDProgressiveImageCoder`, `SDAnimatedImageCoder`.
 */
FOUNDATION_EXPORT RBImageCoderOption _Nonnull const RBImageCoderDecodeThumbnailPixelSize;
...
/**
 ...
 @note works for `SDImageCoder`.
 */
FOUNDATION_EXPORT RBImageCoderOption _Nonnull const RBImageCoderEncodeFirstFrameOnly;
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT RBImageCoderOption _Nonnull const RBImageCoderEncodeCompressionQuality;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT RBImageCoderOption _Nonnull const RBImageCoderEncodeBackgroundColor;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT RBImageCoderOption _Nonnull const RBImageCoderEncodeMaxPixelSize;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT RBImageCoderOption _Nonnull const RBImageCoderEncodeMaxFileSize;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT RBImageCoderOption _Nonnull const RBImageCoderEncodeEmbedThumbnail;

/**
 A RBWebImageContext object which hold the original context options from top-level API. (RBWebImageContext)
 ...
 See `RBWebImageContext` for more detailed information.
 */
FOUNDATION_EXPORT RBImageCoderOption _Nonnull const RBImageCoderWebImageContext API_DEPRECATED("The coder component will be seperated from Core subspec in the future. Update your code to not rely on this context option.", macos(10.10, API_TO_BE_DEPRECATED), ios(8.0, API_TO_BE_DEPRECATED), tvos(9.0, API_TO_BE_DEPRECATED), watchos(2.0, API_TO_BE_DEPRECATED));
 ...
 */
@protocol RBImageCoder <NSObject>
...
- (nullable UIImage *)decodedImageWithData:(nullable NSData *)data
                                   options:(nullable RBImageCoderOptions *)options;
 ...
 */
- (BOOL)canEncodeToFormat:(RBImageFormat)format NS_SWIFT_NAME(canEncode(to:));
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol RBProgressiveImageCoder <RBImageCoder>
 ...
 */
- (nonnull instancetype)initIncrementalWithOptions:(nullable RBImageCoderOptions *)options;
 ...
 */
- (nullable UIImage *)incrementalDecodedImageWithOptions:(nullable RBImageCoderOptions *)options;
 ...
 */
@protocol RBAnimatedImageProvider <NSObject>
 ...
 */
@protocol RBAnimatedImageCoder <RBImageCoder, RBAnimatedImageProvider>
 ...
 */
- (nullable instancetype)initWithAnimatedImageData:(nullable NSData *)data options:(nullable RBImageCoderOptions *)options;
