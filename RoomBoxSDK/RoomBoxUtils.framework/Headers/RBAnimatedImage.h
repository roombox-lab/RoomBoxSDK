 ...
 */
@protocol RBAnimatedImage <RBAnimatedImageProvider>
 ...
 */
- (nullable instancetype)initWithData:(nonnull NSData *)data scale:(CGFloat)scale options:(nullable RBImageCoderOptions *)options;
...
/**
 ...
 @return An initialized object
 */
- (nullable instancetype)initWithAnimatedCoder:(nonnull id<RBAnimatedImageCoder>)animatedCoder scale:(CGFloat)scale;
...
/**
 ...
 @note We use this with animated coder which conforms to `SDProgressiveImageCoder` for progressive animation decoding.
 */
@property (nonatomic, strong, readonly, nullable) id<RBAnimatedImageCoder> animatedCoder;
 ...
 */
@interface RBAnimatedImage : UIImage <RBAnimatedImage>
 ...
 */
@property (nonatomic, assign, readonly) RBImageFormat animatedImageFormat;
