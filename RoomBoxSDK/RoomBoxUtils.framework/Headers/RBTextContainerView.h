 ...
 */
@interface RBTextContainerView : UIView
...
@property (nullable, nonatomic, strong) RBTextLayout *layout;
...
- (void)setLayout:(nullable RBTextLayout *)layout withFadeDuration:(NSTimeInterval)fadeDuration;
