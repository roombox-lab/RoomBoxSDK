...
@protocol RBTextLinePositionModifier;
 ...
 */
extern const CGSize RBTextContainerMaxSize;
...
/**
 ...
 Example:
     ...
     └─────────────────────────────┘
 */
@interface RBTextContainer : NSObject <NSCoding, NSCopying>
...
@property RBTextTruncationType truncationType;
...
@property (nullable, copy) id<RBTextLinePositionModifier> linePositionModifier;
@end
 ...
 */
@protocol RBTextLinePositionModifier <NSObject, NSCopying>
@required
/**
 ...
 */
- (void)modifyLines:(NSArray<RBTextLine *> *)lines fromText:(NSAttributedString *)text inContainer:(RBTextContainer *)container;
@end
 ...
 */
@interface RBTextLinePositionSimpleModifier : NSObject <RBTextLinePositionModifier>
...
/**
 ...
 example: (layout with a circle exclusion path)
     ...
     └──────────────────────────┘
 */
@interface RBTextLayout : NSObject <NSCoding>
...
*/
+ (nullable RBTextLayout *)layoutWithContainerSize:(CGSize)size text:(NSAttributedString *)text;
...
/**
 ...
 @return A new layout, or nil when an error occurs.
 */
+ (nullable RBTextLayout *)layoutWithContainer:(RBTextContainer *)container text:(NSAttributedString *)text;
...
/**
 ...
 @return A new layout, or nil when an error occurs.
 */
+ (nullable RBTextLayout *)layoutWithContainer:(RBTextContainer *)container text:(NSAttributedString *)text range:(NSRange)range;
 ...
 */
+ (nullable NSArray<RBTextLayout *> *)layoutWithContainers:(NSArray<RBTextContainer *> *)containers
...
///< The text container
@property (nonatomic, strong, readonly) RBTextContainer *container;
///< The full text
...
@property (nonatomic, strong, readonly) NSArray<RBTextLine *> *lines;
///< YYTextLine with truncated token, or nil
@property (nullable, nonatomic, strong, readonly) RBTextLine *truncatedLine;
///< Array of `YYTextAttachment`
@property (nullable, nonatomic, strong, readonly) NSArray<RBTextAttachment *> *attachments;
 ...
 */
- (nullable RBTextPosition *)closestPositionToPoint:(CGPoint)point;
...
/**
 ...
 @return A text position, or nil if not found.
 */
- (nullable RBTextPosition *)positionForPoint:(CGPoint)point
                                  oldPosition:(RBTextPosition *)oldPosition
                                otherPosition:(RBTextPosition *)otherPosition;
 ...
 */
- (nullable RBTextRange *)textRangeAtPoint:(CGPoint)point;
...
/**
 ...
 at point. Or nil if not found.
 */
- (nullable RBTextRange *)closestTextRangeAtPoint:(CGPoint)point;
 ...
 */
- (nullable RBTextRange *)textRangeByExtendingPosition:(RBTextPosition *)position;
...
/**
 ...
 @return The line index, or NSNotFound if not found.
 */
- (NSUInteger)lineIndexForPosition:(RBTextPosition *)position;
 ...
 */
- (CGPoint)linePositionForPosition:(RBTextPosition *)position;
 ...
 */
- (CGRect)caretRectForPosition:(RBTextPosition *)position;
...
/**
 ...
 If not found, it returns CGRectNull.
 */
- (CGRect)firstRectForRange:(RBTextRange *)range;
...
/**
 ...
 If not found, it returns CGRectNull.
 */
- (CGRect)rectForRange:(RBTextRange *)range;
 ...
 */
- (NSArray<RBTextSelectionRect *> *)selectionRectsForRange:(RBTextRange *)range;
...
/**
 ...
 If not found, the array is empty.
 */
- (NSArray<RBTextSelectionRect *> *)selectionRectsWithoutStartAndEndForRange:(RBTextRange *)range;
 ...
 */
- (NSArray<RBTextSelectionRect *> *)selectionRectsWithOnlyStartAndEndForRange:(RBTextRange *)range;
...
- (void)drawInContext:(nullable CGContextRef)context
                ...
                debug:(nullable RBTextDebugOption *)debug
