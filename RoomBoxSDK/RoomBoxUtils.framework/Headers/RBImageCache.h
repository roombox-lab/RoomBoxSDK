...
/// Image Cache Options
typedef NS_OPTIONS(NSUInteger, RBImageCacheOptions) {
    /**
     ...
     */
    RBImageCacheQueryMemoryData = 1 << 0,
    /**
     ...
     */
    RBImageCacheQueryMemoryDataSync = 1 << 1,
    /**
     ...
     */
    RBImageCachePreloadAllFrames = 1 << 6,
    /**
     * By default, when you use `RBWebImageContextAnimatedImageClass` context option (like using `SDAnimatedImageView` which designed to use `SDAnimatedImage`), we may still use `UIImage` when the memory cache hit, or image decoder is not available, to behave as a fallback solution.
     ...
     */
    RBImageCacheMatchAnimatedImageClass = 1 << 7,
};
 ...
 */
@interface RBImageCache : NSObject
 ...
 */
@property (nonatomic, copy, nonnull, readonly) RBImageCacheConfig *config;
 ...
 */
@property (nonatomic, strong, readonly, nonnull) id<RBMemoryCache> memoryCache;
 ...
 */
@property (nonatomic, strong, readonly, nonnull) id<RBDiskCache> diskCache;
 ...
 */
@property (nonatomic, copy, nullable) RBImageCacheAdditionalCachePathBlock additionalCachePathBlock;
 ...
 */
@property (nonatomic, class, readonly, nonnull) RBImageCache *sharedImageCache;
...
- (nonnull instancetype)initWithNamespace:(nonnull NSString *)ns
                       diskCacheDirectory:(nullable NSString *)directory
                                   config:(nullable RBImageCacheConfig *)config NS_DESIGNATED_INITIALIZER;
 ...
 */
- (void)diskImageExistsWithKey:(nullable NSString *)key completion:(nullable RBImageCacheCheckCompletionBlock)completionBlock;
 ...
 *  @note the completion block will be always executed on the main queue
 */
- (void)diskImageDataQueryForKey:(nullable NSString *)key completion:(nullable RBImageCacheQueryDataCompletionBlock)completionBlock;
 ...
 */
- (nullable NSOperation *)queryCacheOperationForKey:(nullable NSString *)key done:(nullable RBImageCacheQueryCompletionBlock)doneBlock;
 ...
 * @return a NSOperation instance containing the cache op
 */
- (nullable NSOperation *)queryCacheOperationForKey:(nullable NSString *)key options:(RBImageCacheOptions)options done:(nullable RBImageCacheQueryCompletionBlock)doneBlock;
 ...
 * @return a NSOperation instance containing the cache op
 */
- (nullable NSOperation *)queryCacheOperationForKey:(nullable NSString *)key options:(RBImageCacheOptions)options context:(nullable RBWebImageContext *)context done:(nullable RBImageCacheQueryCompletionBlock)doneBlock;
 ...
 * @return a NSOperation instance containing the cache op
 */
- (nullable NSOperation *)queryCacheOperationForKey:(nullable NSString *)key options:(RBImageCacheOptions)options context:(nullable RBWebImageContext *)context cacheType:(RBImageCacheType)queryCacheType done:(nullable RBImageCacheQueryCompletionBlock)doneBlock;
 ...
 * @return The image for the given key, or nil if not found.
 */
- (nullable UIImage *)imageFromDiskCacheForKey:(nullable NSString *)key options:(RBImageCacheOptions)options context:(nullable RBWebImageContext *)context;
 ...
 * @return The image for the given key, or nil if not found.
 */
- (nullable UIImage *)imageFromCacheForKey:(nullable NSString *)key options:(RBImageCacheOptions)options context:(nullable RBWebImageContext *)context;
 ...
 */
- (void)removeImageForKey:(nullable NSString *)key withCompletion:(nullable RBWebImageNoParamsBlock)completion;
 ...
 * @param completion      A block that should be executed after the image has been removed (optional)
 */
- (void)removeImageForKey:(nullable NSString *)key fromDisk:(BOOL)fromDisk withCompletion:(nullable RBWebImageNoParamsBlock)completion;
 ...
 */
- (void)clearDiskOnCompletion:(nullable RBWebImageNoParamsBlock)completion;

/**
 * Asynchronously remove all expired cached image from disk. Non-blocking method - returns immediately.
 * @param completionBlock A block that should be executed after cache expiration completes (optional)
 */
- (void)deleteOldFilesWithCompletionBlock:(nullable RBWebImageNoParamsBlock)completionBlock;
 ...
 */
- (void)calculateSizeWithCompletionBlock:(nullable RBImageCacheCalculateSizeBlock)completionBlock;
 ...
 */
@interface RBImageCache (RBImageCache) <RBImageCache>
