...
typedef NSURLResponse * _Nullable (^RBWebImageDownloaderResponseModifierBlock)(NSURLResponse * _Nonnull response);
 ...
 */
@protocol RBWebImageDownloaderResponseModifier <NSObject>
 ...
 */
@interface RBWebImageDownloaderResponseModifier : NSObject <RBWebImageDownloaderResponseModifier>

/// Create the response modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull RBWebImageDownloaderResponseModifierBlock)block;

/// Create the response modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)responseModifierWithBlock:(nonnull RBWebImageDownloaderResponseModifierBlock)block;
...
*/
@interface RBWebImageDownloaderResponseModifier (Conveniences)
