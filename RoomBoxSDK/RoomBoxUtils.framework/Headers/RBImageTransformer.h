 ...
 */
FOUNDATION_EXPORT NSString * _Nullable RBTransformedKeyForKey(NSString * _Nullable key, NSString * _Nonnull transformerKey);
 ...
 */
FOUNDATION_EXPORT NSString * _Nullable RBThumbnailedKeyForKey(NSString * _Nullable key, CGSize thumbnailPixelSize, BOOL preserveAspectRatio);

/**
 A transformer protocol to transform the image load from cache or from download.
 You can provide transformer to cache and manager (Through the `transformer` property or context option `RBWebImageContextImageTransformer`).
 
 @note The transform process is called from a global queue in order to not to block the main queue.
 */
@protocol RBImageTransformer <NSObject>
 ...
 */
@interface RBImagePipelineTransformer : NSObject <RBImageTransformer>

/**
 All transformers in pipeline
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<id<RBImageTransformer>> *transformers;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithTransformers:(nonnull NSArray<id<RBImageTransformer>> *)transformers;
 ...
 */
@interface RBImageRoundCornerTransformer: NSObject <RBImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) RBRectCorner corners;
...
- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithRadius:(CGFloat)cornerRadius corners:(RBRectCorner)corners borderWidth:(CGFloat)borderWidth borderColor:(nullable UIColor *)borderColor;
 ...
 */
@interface RBImageResizingTransformer : NSObject <RBImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) RBImageScaleMode scaleMode;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithSize:(CGSize)size scaleMode:(RBImageScaleMode)scaleMode;
 ...
 */
@interface RBImageCroppingTransformer : NSObject <RBImageTransformer>
 ...
 */
@interface RBImageFlippingTransformer : NSObject <RBImageTransformer>
 ...
 */
@interface RBImageRotationTransformer : NSObject <RBImageTransformer>
 ...
 */
@interface RBImageTintTransformer : NSObject <RBImageTransformer>
 ...
 */
@interface RBImageBlurTransformer : NSObject <RBImageTransformer>
 ...
 */
@interface RBImageFilterTransformer: NSObject <RBImageTransformer>
