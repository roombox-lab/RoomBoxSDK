 ...
 */
@interface UIView (RBWebCacheOperation)
 ...
 */
- (nullable id<RBWebImageOperation>)rb_imageLoadOperationForKey:(nullable NSString *)key;
 ...
 */
- (void)rb_setImageLoadOperation:(nullable id<RBWebImageOperation>)operation forKey:(nullable NSString *)key;
 ...
 *  @param key key for identifying the operations
 */
- (void)rb_cancelImageLoadOperationWithKey:(nullable NSString *)key;
 ...
 *  @param key key for identifying the operations
 */
- (void)rb_removeImageLoadOperationWithKey:(nullable NSString *)key;
