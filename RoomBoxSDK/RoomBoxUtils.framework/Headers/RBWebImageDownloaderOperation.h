 ...
 */
@protocol RBWebImageDownloaderOperation <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
@required
...
- (nullable id)addHandlersForProgress:(nullable RBWebImageDownloaderProgressBlock)progressBlock
 ...
 */
@interface RBWebImageDownloaderOperation : NSOperation <RBWebImageDownloaderOperation>
 ...
 */
@property (assign, nonatomic, readonly) RBWebImageDownloaderOptions options;

/**
 * The context for the receiver.
 */
@property (copy, nonatomic, readonly, nullable) RBWebImageContext *context;
...
- (nonnull instancetype)initWithRequest:(nullable NSURLRequest *)request
                              inSession:(nullable NSURLSession *)session
                                options:(RBWebImageDownloaderOptions)options
                                context:(nullable RBWebImageContext *)context NS_DESIGNATED_INITIALIZER;
