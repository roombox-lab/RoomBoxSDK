 ...
 */
@interface RBImageCodersManager : NSObject <RBImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) RBImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<RBImageCoder>> *coders;
...
/**
 ...
 @param coder coder
 */
- (void)addCoder:(nonnull id<RBImageCoder>)coder;
...
/**
 ...
 @param coder coder
 */
- (void)removeCoder:(nonnull id<RBImageCoder>)coder;
