 ...
 */
@protocol RBTextKeyboardObserver <NSObject>
@optional
- (void)keyboardChangedWithTransition:(RBTextKeyboardTransition)transition;
@end
 ...
 */
@interface RBTextKeyboardManager : NSObject
 ...
 */
- (void)addObserver:(id<RBTextKeyboardObserver>)observer;
 ...
 */
- (void)removeObserver:(id<RBTextKeyboardObserver>)observer;
