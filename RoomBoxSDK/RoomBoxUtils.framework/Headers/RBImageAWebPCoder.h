...
@interface RBImageAWebPCoder : RBImageIOAnimatedCoder <RBProgressiveImageCoder, RBAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) RBImageAWebPCoder *sharedCoder;
