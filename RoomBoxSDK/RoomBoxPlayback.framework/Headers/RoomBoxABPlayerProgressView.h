...
@protocol RoomBoxABPlayerProgressViewDelegate <NSObject>
...
- (void)playerProgressViewSliderChanged:(double)value;
- (void)playerProgressViewSliderTouchEnded:(double)value;
- (void)playerProgressViewSliderTapped:(double)value;
...
@interface RoomBoxABPlayerProgressView : UIView
@property (nonatomic, weak) id<RoomBoxABPlayerProgressViewDelegate> delegate;
@property (nonatomic, strong, readonly) UIButton *playButton;
@property (nonatomic, strong, readonly) UILabel *currentTimeLabel;
@property (nonatomic, strong, readonly) UILabel *totalTimeLabel;
@property (nonatomic, strong, readonly) RoomBoxSliderView *slider;
@property (nonatomic, strong, readonly) RoomBoxABPlayerProgressBar *sliderBar;
