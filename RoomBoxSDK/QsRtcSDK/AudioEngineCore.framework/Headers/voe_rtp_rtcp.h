...
class WEBRTC_DLLEXPORT VoERTP_RTCP {
 public:
  ...
  // Sets the shared audio flag to a specified |channel|.
  virtual int SetSharedAudio(int channel, bool enable) = 0;

  // Gets the shared audio flag of a specified |channel|.
  virtual int GetSharedAudio(int channel, bool& enable) = 0;
