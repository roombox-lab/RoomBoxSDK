...
class WEBRTC_DLLEXPORT VoENetwork {
 public:
  ...
  virtual int RegisterExternalTransportRefactor(int channel, TransportRefactor& transport) = 0;
  ...
  // add by my at 2019.04.25
  //添加上层直接丢包参数，从而设置Opus编码器FEC强度
  virtual int RecoverableUplinkPacketLossRate(
      int channel,
