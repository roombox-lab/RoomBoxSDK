...
#include <windows.h>
#define TANG_CALL __cdecl
#if defined(TANGRTC_EXPORT)
#define TANG_API extern "C" __declspec(dllexport)
#else
#define TANG_API extern "C" __declspec(dllimport)
#endif
#elif defined(__APPLE__)
#include <TargetConditionals.h>
#define TANG_API __attribute__((visibility("default"))) extern "C"
#define TANG_CALL
#elif defined(__ANDROID__) || defined(__linux__)
#define TANG_API extern "C" __attribute__((visibility("default")))
#define TANG_CALL
#else
#define TANG_API extern "C"
#define TANG_CALL
#endif
...
{
    TANG_IID_AUDIO_DEVICE_MANAGER = 1,
    TANG_IID_VIDEO_DEVICE_MANAGER = 2,
    TANG_IID_RTC_ENGINE_PARAMETER = 3,
    TANG_IID_MEDIA_ENGINE = 4,
    TANG_IID_SIGNALING_ENGINE = 8,
};
  ...
  */
    ...
    */
    ...
    /** **DEPRECATED** 105: The server rejects the request to look up the channel. The server cannot process this request or the request is illegal.
     ...
     Deprecated as of v2.4.1. Use CONNECTION_CHANGED_REJECTED_BY_SERVER(10) in the \ref tang::rtc::IRtcEngineEventHandler::onConnectionStateChanged "onConnectionStateChanged" callback instead.
    */
...
enum ERROR_CODE_TYPE
{
  ...
  */
    ...
    */
     ...
     */
    ERR_NET_NOBUFS = 15,
    /** 17: The request to join the channel is rejected. This error usually occurs when the user is already in the channel, and still calls the method to join the channel, for example, \ref tang::rtc::IRtcEngine::joinChannel "joinChannel".
     */
    ...
    /** 18: The request to leave the channel is rejected.
     ...
     - When the user has left the channel and still calls \ref tang::rtc::IRtcEngine::leaveChannel "leaveChannel" to leave the channel. In this case, stop calling \ref tang::rtc::IRtcEngine::leaveChannel "leaveChannel".
     - When the user has not joined the channel and still calls \ref tang::rtc::IRtcEngine::leaveChannel "leaveChannel" to leave the channel. In this case, no extra operation is needed.
     */
    ...
    /** **DEPRECATED** 109: Deprecated as of v2.4.1. Use CONNECTION_CHANGED_TOKEN_EXPIRED(9) in the \ref tang::rtc::IRtcEngineEventHandler::onConnectionStateChanged "onConnectionStateChanged" callback instead.
     
     The token expired due to one of the following reasons:
     
     - Authorized Timestamp expired: The timestamp is represented by the number of seconds elapsed since 1/1/1970. The user can use the Token to access the Tang service within five minutes after the Token is generated. If the user does not access the Tang service after five minutes, this Token is no longer valid.
     - Call Expiration Timestamp expired: The timestamp is the exact time when a user can no longer use the Tang service (for example, when a user is forced to leave an ongoing call). When a value is set for the Call Expiration Timestamp, it does not mean that the token will expire, but that the user will be banned from the channel.
     */
    ERR_TOKEN_EXPIRED = 109,
    /** **DEPRECATED** 110: Deprecated as of v2.4.1. Use CONNECTION_CHANGED_INVALID_TOKEN(8) in the \ref tang::rtc::IRtcEngineEventHandler::onConnectionStateChanged "onConnectionStateChanged" callback instead.
     ...
     - The uid is mandatory, and users must set the same uid as the one set in the \ref tang::rtc::IRtcEngine::joinChannel "joinChannel" method.
     */
    ...
    /** 113: The user is not in the channel when calling the \ref tang::rtc::IRtcEngine::sendStreamMessage "sendStreamMessage" or \ref tang::rtc::IRtcEngine::getUserInfoByUserAccount "getUserInfoByUserAccount" method.
     */
    ERR_NOT_IN_CHANNEL = 113,
    /** 114: The size of the sent data is over 1024 bytes when the user calls the \ref tang::rtc::IRtcEngine::sendStreamMessage "sendStreamMessage" method.
     */
    ERR_SIZE_TOO_LARGE = 114,
    /** 115: The bitrate of the sent data exceeds the limit of 6 Kbps when the user calls the \ref tang::rtc::IRtcEngine::sendStreamMessage "sendStreamMessage" method.
     */
    ERR_BITRATE_LIMIT = 115,
    /** 116: Too many data streams (over 5 streams) are created when the user calls the \ref tang::rtc::IRtcEngine::createDataStream "createDataStream" method.
     */
    ...
    /** 130: Encryption is enabled when the user calls the \ref tang::rtc::IRtcEngine::addPublishStreamUrl "addPublishStreamUrl" method (CDN live streaming does not support encrypted streams).
     */
    ERR_ENCRYPTED_STREAM_NOT_ALLOWED_PUBLISH = 130,
    /** 134: The user account is invalid. */
    ERR_INVALID_USER_ACCOUNT = 134,

    /** 151: CDN related errors. Remove the original URL address and add a new one by calling the \ref tang::rtc::IRtcEngine::removePublishStreamUrl "removePublishStreamUrl" and \ref tang::rtc::IRtcEngine::addPublishStreamUrl "addPublishStreamUrl" methods.
     */
    ...
    /** 154: An error occurs in Tang's streaming server. Call the addPublishStreamUrl method to publish the streaming again.
     */
    ...
    */
    ...
    Deprecated as of v2.4.1. Use LOCAL_VIDEO_STREAM_ERROR_CAPTURE_FAILURE(4) in the \ref tang::rtc::IRtcEngineEventHandler::onConnectionStateChanged "onConnectionStateChanged" callback instead.
     */
    ...
    */
	...
	/** **DEPRECATED** 1502: Video Device Module: The camera in use.
     ...
     Deprecated as of v2.4.1. Use LOCAL_VIDEO_STREAM_ERROR_DEVICE_BUSY(3) in the \ref tang::rtc::IRtcEngineEventHandler::onConnectionStateChanged "onConnectionStateChanged" callback instead.
	 */
